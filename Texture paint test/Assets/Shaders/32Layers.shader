Shader "Custom/32Layers"
    {
        Properties
        {
            ...
            _Texture26 ("Texture 26", 2D) = "white" {}
            _Mask26 ("Mask 26", 2D) = "black" {}
            _Texture27 ("Texture 27", 2D) = "white" {}
            _Mask27 ("Mask 27", 2D) = "black" {}
            _Texture28 ("Texture 28", 2D) = "white" {}
            _Mask28 ("Mask 28", 2D) = "black" {}
            _Texture29 ("Texture 29", 2D) = "white" {}
            _Mask29 ("Mask 29", 2D) = "black" {}
            _Texture30 ("Texture 30", 2D) = "white" {}
            _Mask30 ("Mask 30", 2D) = "black" {}
            _Texture31 ("Texture 31", 2D) = "white" {}
            _Mask31 ("Mask 31", 2D) = "black" {}
        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                Texture2D _Mask25;
                Texture2D _Texture26;
                Texture2D _Mask26;
                Texture2D _Texture27;
                Texture2D _Mask27;
                Texture2D _Texture28;
                Texture2D _Mask28;
                Texture2D _Texture29;
                Texture2D _Mask29;
                Texture2D _Texture30;
                Texture2D _Mask30;
                Texture2D _Texture31;
                Texture2D _Mask31;
                ...
                fixed4 frag (v2f i) : SV_Target
                {
                    ...
                    col = lerp(col, _Texture26.Sample(sampler_linear_repeat, i.uv), _Mask26.Sample(sampler_linear_repeat, i.maskuv));
                    col = lerp(col, _Texture27.Sample(sampler_linear_repeat, i.uv), _Mask27.Sample(sampler_linear_repeat, i.maskuv));
                    col = lerp(col, _Texture28.Sample(sampler_linear_repeat, i.uv), _Mask28.Sample(sampler_linear_repeat, i.maskuv));
                    col = lerp(col, _Texture29.Sample(sampler_linear_repeat, i.uv), _Mask29.Sample(sampler_linear_repeat, i.maskuv));
                    col = lerp(col, _Texture30.Sample(sampler_linear_repeat, i.uv), _Mask30.Sample(sampler_linear_repeat, i.maskuv));
                    col = lerp(col, _Texture31.Sample(sampler_linear_repeat, i.uv), _Mask31.Sample(sampler_linear_repeat, i.maskuv));
